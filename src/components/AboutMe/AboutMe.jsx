									...
									<div className='px-5 py-3'>
										<div className='p-3'>
											...
											<p className='text-[14px] text-justify font-[300]'>
												👋 I'm Toma. Fictional person
												for preview purposes :) I'm
												working with newest front-end
												frameworks like Angular, React
												and Vue. What you are seeing now
												is portfolio template from
												Dorota1997. If you like this
												portfolio template, make sure to
												⭐ the repository to make it
												more recognizable for other
												users. Thank you 💜
											</p>
										</div>
									</div>
